                    ...
                    <div class="example-wrap">
                        <div class="example">
                            ...
                            <table id="dataTableEvents"
                                   ...
                                   data-url="${base}/manage/category/data" data-cache="false" data-striped="true" data-method="post" data-data-type="json" data-content-type="application/x-www-form-urlencoded"
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <th data-field="category_name" data-align="center" data-valign="middle" data-sortable="true">分类名称</th>
                                    <th data-field="levelDesc" data-align="center" data-valign="middle">级别</th>
                                    <th data-field="priority" data-align="center" data-valign="middle">顺序</th>
                                    <th data-field="category_path" data-align="center" data-valign="middle">访问路径</th>
...
<script type="text/javascript">
    ...
    function operateFormatter(value, row, index) {
        return [
            '<button class="btn btn-info btn-circle edit btn-tb"  title="编辑">',
            '<i class="glyphicon glyphicon-edit"></i>',
            '</button>',
            '<button class="btn btn-danger btn-circle remove btn-tb"  title="删除">',
    ...
    window.operateEvents = {
        'click .edit': function (e, value, row) {
            window.location.href = '${base}/manage/category/edit/' + row.category_id;
        },
        'click .remove': function (e, value, row) {
            parent.layer.confirm('您确认要删除这条数据吗？', {
                ...
                $.getJSON("${base}/manage/category/disable/" + row.category_id, function (data) {
