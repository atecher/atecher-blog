...
<head>
    ...
    <title>${web_manager_title!'后台管理系统'} - 控制台</title>
    <meta name="keywords" content="${keywords!''}">
    <meta name="description" content="${description!''}">
    <link href="${base}/asset/favicon/favicon.png" rel="Shortcut Icon" type="image/x-icon"/>
    <link href="${base}/asset/favicon/favicon.png" rel="Bookmark"/>
...
<div class="pace  pace-inactive">
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="profile-element" style="margin-left: 20px;">
                            <span><img alt="image" class="img-circle" src="${website_current_user.avatar}" width="80" height="80" onerror="this.src='${base}/asset/favicon/favicon_white.png'" ></span>
                        ...
                        <#list menu as menu>
                    	<li>
			                <a href="${base}${menu.url}"><i class="${menu.icon!''}"></i><span class="nav-label">${menu.name}</span><span class="fa arrow"></span></a>
                        <#if menu.children?? && (menu.children?size> 0)>
                            <ul class="nav nav-second-level collapse">
                            <#list menu.children as child>
                            <li><a class="J_menuItem" href="${base}${child.url}" data-index="${child.id}"><i class="${child.icon!""}"></i>${child.name}</a></li>
                            </#list>
                            </ul>
                         </#if>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-messages">
                                <li class="m-t-xs">
                                    <div class="dropdown-messages-box">
                                        <a href="http://www.zi-han.net/theme/hplus/profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${base}/asset/console/img/a7.jpg">
                                        </a>
                                ...
                                <li>
                                    <div class="dropdown-messages-box">
                                        <a href="http://www.zi-han.net/theme/hplus/profile.html" class="pull-left">
                                            <img alt="image" class="img-circle" src="${base}/asset/console/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="J_menuItem"  href="${base}/user/avatar" data-index="0">
                                        <div>修改头像</div>
                                    </a>
                                </li>
                                <li>
            ...
            <div class="row content-tabs">
                ...
                <a href="${base}/account/logout" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${base}/admin/dashboard" frameborder="0" data-id="index_v1.html" seamless=""></iframe>
            </div>
            <div class="footer">
                    ...
                    <div id="tab-2" class="tab-pane">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="http://www.zi-han.net/theme/hplus/index.html#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${base}/asset/console/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="http://www.zi-han.net/theme/hplus/index.html#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${base}/asset/console/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="http://www.zi-han.net/theme/hplus/index.html#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${base}/asset/console/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="http://www.zi-han.net/theme/hplus/index.html#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${base}/asset/console/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="http://www.zi-han.net/theme/hplus/index.html#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${base}/asset/console/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="http://www.zi-han.net/theme/hplus/index.html#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="${base}/asset/console/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <script type="text/javascript" src="${base}/asset/console/js/plugins/layer/layer.min.js"></script>
    <script type="text/javascript" src="${base}/asset/console/js/hplus.min.js"></script>
    <script type="text/javascript" src="${base}/asset/console/js/contabs.min.js"></script>
    <script type="text/javascript" src="${base}/asset/console/js/pace.min.js"></script>
